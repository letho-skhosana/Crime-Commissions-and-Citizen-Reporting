...
/charts
    ...
    police_model.png
/data
    rustenburg_municipality_crime_data.csv
    sapacr-2008-2023-v1.1.csv
/notebooks  
    NB01-Data-Transformation.ipynb  
    NB02-Regression-Models.ipynb  
    NB03-Charts.ipynb  
/model-summaries  
    citizen_model.txt
    parallel_trends(citizen_model).txt
    parallel_trends(police_model).txt
    police_model.txt
README.md
